...
export class ExampleNetworkedEntity extends Schema {
    ...
    @type("number") seat: number = 0; //MODH
    @type("boolean") gameStarted: boolean = false;  //MODH
    @type("number") tries: number = 0; //MODH
    @type("number") score: number = 0; //MODH
    @type("number") eSeat: number = 0; //NMODH
}
