...
public class LobbyController : MonoBehaviour
{
    ...
    public string gameSceneName = "BasketballGame";
    [SerializeField]
	...
	public void joinOrCreateByHugo()
    {
		if(GameObject.FindWithTag("roomEntry")==null)
        {
			connectingCover.SetActive(true);
			LoadGallery(() => { ExampleManager.Instance.CreateNewRoom("abc123"); });
		}
        ...
        {
			GameObject.FindWithTag("roomEntry").GetComponent<RoomListItem>().TryJoin();
		}
    }
    ...
    {
        StartCoroutine(LoadSceneAsync("BasketballGame", onComplete));
    }
    ...
    private IEnumerator LoadSceneAsync(string scene, Action onComplete)
    {
        ...
        while (op.progress != 1.0f/*<= 0.9f*/) //MODH
        {
