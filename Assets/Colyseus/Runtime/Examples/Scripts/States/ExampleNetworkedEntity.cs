...
public partial class ExampleNetworkedEntity : Schema {
	...
	[Type(18, "number")]
	public float seat = default(float); //MODH

	[Type(19, "boolean")]
	public bool gameStarted = default(bool); //MODH

	[Type(20, "number")]
	public float tries = default(float); //MODH

	[Type(21, "number")]
	public float score = default(float); //MODH

	[Type(22, "number")]
	public float eSeat = default(float); //NMODH
}
